...
var main = (function () {
    ...
    var configs = (function () {
        ...
        Singleton.defaultOptions = {
            ...
            welcome: "Welcome to On1on Studio.\nAre you looking for a server that can provide you with Roblox in game services and Roblox studio help? Well look no further as On1on Studio has everything you need.\nNow in order to get started, feel free to either execute the 'help' command or use the more user-friendly colored side navigation bar at your left.\nIn order to skip text rolling, double click/touch anywhere.",
            internet_explorer_warning: "NOTE: I see you're using internet explorer, this website won't work properly.",
            welcome_file_name: "welcome_message.txt",
            invalid_command_message: "<value>: command not found.",
            reboot_message: "Preparing to reboot...\n\n3...\n\n2...\n\n1...\n\nRebooting...\n\n",
            on1on_help_message: "I'm just an onion.",
    ...
    var files = (function () {
        ...
        Singleton.defaultOptions = {
            "about.txt": "This is a test website for On1on Studio.",
            "help.txt": "First, go outside your home.\nSecond, find a seat.\nThird, close your eyes and hear them loud cars revving up.\nFourth, you realized you need a massage.\nThe end. . .",
            "contact.txt": "haruhangakoa@gmail.com",
            "globalleaks.txt": "https://www.theglobalestablishment.com/",
            "on1onstudio.txt": "https://www.youtube.com/watch?v=dQw4w9WgXcQ"
        };
        return {
            getInstance: function (options) {
                instance === void 0 && (instance = new Singleton(options));
    ...
    var cmds = {
        ...
        ON1ON: { value: "on1on", help: configs.getInstance().on1on_help },
    ...
    Terminal.prototype.on1on = function () {
        this.type(configs.getInstance().on1on_help_message, this.unlock.bind(this));
    };
